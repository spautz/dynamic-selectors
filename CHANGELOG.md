...
- Add `@dynamic-selectors/with-reselect`
  package ([#7](https://github.com/spautz/dynamic-selectors/issues/7)) ([be26b0c](https://github.com/spautz/dynamic-selectors/commit/be26b0c95f7b0e7df3562d8b7bfc629dbebfbc46))
...
- `@dynamic-selectors/core`: Cleanup and validate options (dev
  only) ([#6](https://github.com/spautz/dynamic-selectors/issues/6)) ([66d3b48](https://github.com/spautz/dynamic-selectors/commit/66d3b4859679262f198ea2d4ceee49201e7996fd))
...
- `@dynamic-selectors/core`: Add read-only dependencies as first-class
...
- `@dynamic-selectors/core`: Add resetCache, with more
...
- `@dynamic-selectors/core`: Bugfix for readonly runs, with test
